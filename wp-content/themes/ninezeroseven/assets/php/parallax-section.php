...
<section class="parallax <?php echo get_post_type();?>-<?php echo $parallax_ID;?> <?php echo $extra_class;?>" id="<?php echo get_post_type();?>-<?php echo get_the_ID();?>"<?php echo $p_data_tag;?>>
