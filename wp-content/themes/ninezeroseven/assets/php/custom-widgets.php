...
if(!function_exists('nzs_register_custom_widgets')){
  function nzs_register_custom_widgets(){
    register_widget( 'NZS_Comments_Widget' );
    register_widget( 'NZS_Responsive_Video' );
    register_widget( 'NZS_Flickr_Widget' );
    register_widget( 'NZS_Big_Ad' );
    register_widget( 'NZS_Ad_Small' );
    
  }
  add_action('widgets_init','nzs_register_custom_widgets');
}
/************************************************************************
...
*************************************************************************/
 ...
 class NZS_Comments_Widget extends WP_Widget {
     ...
     function __construct() {
         ...
         parent::__construct( 'widget', '907 Comments', $widget_ops );
     }
...
?>
     <li>
        ...
        <img src="<?php echo nzs_get_avatar_url(get_avatar( $comment->comment_author_email, $size = '80', $default = '', $alt = false ));?>" alt="" class="img-frame" width="80" height="80" />
 ...
 *************************************************************************/
 ...
 class NZS_Responsive_Video extends WP_Widget {
     ...
     function __construct() {
         ...
         parent::__construct( 'widget-video', '907 Video', $widget_ops );
     }
...
*************************************************************************/
 ...
 class NZS_Flickr_Widget extends WP_Widget {
     ...
     function __construct() {
         ...
         parent::__construct( 'widget-flickr', '907 Flickr', $widget_ops );
     }
...
*************************************************************************/
 ...
 class NZS_Big_Ad extends WP_Widget {
     ...
     function __construct() {
         ...
         parent::__construct( 'widget-big-ad', '907 Big Ad', $widget_ops );
     }
...
<div class="ads large">
  <a href="<?php echo esc_url($instance['ad_url']); ?>"><img src="<?php echo esc_url($instance['ad_img']); ?>" alt="<?php echo esc_attr($instance['ad_alt']); ?>" width="300" height="250"></a>
</div>
...
*************************************************************************/
 ...
 class NZS_Ad_Small extends WP_Widget {
     ...
     function __construct() {
         ...
         parent::__construct( 'widget-small-ad', '907 Ads', $widget_ops );
     }
   ...
   <a href="<?php echo esc_attr($instance['ad_url'][$i]);?>"><img src="<?php echo esc_attr($instance['ad_img'][$i]);?>" alt="<?php echo esc_attr($instance['ad_alt'][$i]);?>" width="125" height="125"></a>
