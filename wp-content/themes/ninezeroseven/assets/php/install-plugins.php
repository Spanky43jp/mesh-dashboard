...
add_action( 'tgmpa_register', 'nzs_tgm_register_required_plugins' );
/**
 ...
 */
function nzs_tgm_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_template_directory() . '/assets/plugins/revsliderplugin.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
