			...
			<div class="gallery-padding">
				...
				if(has_post_thumbnail()){
					...
					if('image' == $portfolio_type){
						...
						printf('<a href="%1s" title="%2$s" rel="prettyPhoto[main-%2$s]" class="img-preview"><img src="%3$s" alt="%2$s" class="scale-with-grid" width="%4$s" height="%5$s" /></a>',
						$large_image_url[0],
	               	...
	               	//  video		
	               		...
	               		if($video_link){
		               		printf('<a href="%1s" title="%2$s" rel="prettyPhoto[iframes]" class="video-preview"><img src="%3$s" alt="%2$s" class="scale-with-grid" width="%4$s" height="%5$s" /></a>',
		               			esc_attr($video_link),
		               			esc_attr($image_caption),
		               			esc_attr($thumb),
								$t_width,
	               	...
	               	// single image
	               		...
	               		printf('<a href="%1s" title="%2$s" rel="prettyPhoto[%2$s]" class="img-preview"><img src="%3$s" alt="%2$s" class="scale-with-grid" width="%4$s" height="%5$s" /></a>',
				...
				<div class="mouse-effect"></div>
					...
					<?php if(isset($smof_data['nzs_hide_portfolio_link']) && 0 == $smof_data['nzs_hide_portfolio_link']): ?>
						...
						<a href="<?php the_permalink(); ?>" class="go-link hide-text"></a>
