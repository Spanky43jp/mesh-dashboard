...
if(!function_exists('header_heading_font')){
...
if(!function_exists('parallax_css')){
		...
		$page_section_query = new WP_Query( array( 'post_type' => 'parallax-sections', 'posts_per_page' => -1, 'order' => 'ASC' ) ); 
			...
			if($page_section_query->have_posts()): while($page_section_query->have_posts()) : $page_section_query->the_post();
				...
				if(!empty($parallax_style_image)){
					$css_out .= "\tbackground:url(\"".$parallax_style_image."\") ".$repeat." 50% 0 fixed transparent;\n";
				}

				if(!empty($parallax_repeat) && 'cover' == $parallax_repeat){
					$css_out .= "\t-webkit-background-size: cover;\n";
					$css_out .= "\t-moz-background-size: cover;\n";
					$css_out .= "\t-o-background-size: cover;\n";
					$css_out .= "\tbackground-size: cover;\n";
				}
...
if(!function_exists('nzs_custom_nav_css')){
	function nzs_custom_nav_css(){
		...
		if(!empty($custom_logo)){
			...
			$nav_css .= ".main-nav-logo.has-logo-image{\n";
			$nav_css .= "\tbackground-image:url('".$custom_logo."');\n";
...
if(!function_exists('overlay_css')){
...
if(!function_exists('recent_works')){
...
if(!function_exists('portfolio_style')){
...
if(!function_exists('alternate_backgrounds')){
...
if(!function_exists('user_custom_css')){
	function user_custom_css(){
		...
		if(!empty($user_css)){
			...
			$replace_css = array(".topBar h1" => ".topBar .main-nav-logo", ".topBar h1.hide-text" => ".topBar .main-nav-logo.has-logo-image");
			$user_css    = strtr( $user_css, $replace_css);
			$css_user    = '';
...
if(!function_exists('nzs_custom_fonts')){
...
if(!function_exists('parallax_h_style')){
...
if(!function_exists('video_header_styles')){
