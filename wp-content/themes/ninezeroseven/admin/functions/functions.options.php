...
$of_options[] = array( "name" => "Video Quality",
					"desc"        => "Quality of video, if quality is'nt available it will play default",
					"id"          => $prefix."video_quality",
					"std"         => "default",
					"type"        => "select-custom",
					"options"     => array(
							'default' => 'Default',
...
$of_options[] = array( 	"name" 		=> "Grid Width",
						"desc" 		=> "Changes Width Of Site",
						"id" 		=> $prefix."grid_width",
						"std" 		=> 1,
						"on" 		=> "970",
						"off" 		=> "1200",
						"type" 		=> "switch"
...
$of_options[] = array( 	"name" 		=> "Style Changer",
						"desc" 		=> "Adds ability to switch to old style layout",
						"id" 		=> $prefix."style_change",
						"std" 		=> 1,
						"on" 		=> "Old Version",
						"off" 		=> "New Version",
						"type" 		=> "switch"
